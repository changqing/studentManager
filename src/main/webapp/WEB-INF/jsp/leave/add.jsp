...
<html>
  ...
  <body>
	...
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/leave/save" method="post">
			<input type="hidden" name="sid" value="${loginUser.id }"/>
			<input type="hidden" name="sname" value="${loginUser.truename }"/>
			...
			<table id="infoTable">
				...
				<tr>
					...
					<td class="rightTD">
						<textarea rows="6" cols="10" name="content"></textarea>
					</td>
				</tr>
				<tr>
					<td class="leftTD"></td>
