...
<html>
  ...
  <body>
	<div id="vLocation">
		当前位置&nbsp;：通知管理&nbsp;&nbsp;<span class="divider">/</span>&nbsp;&nbsp;<a href="javascript:void(0)">修改通知</a>
	</div>
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/notice/update" method="post">
			<input type="hidden" name="id" value="${n.id }"/>
			<input type="hidden" name="tid" value="${n.tid }"/>
			<input type="hidden" name="tname" value="${n.tname }"/>
			<input type="hidden" name="t" value="${n.publishTime }"/>
			<table id="infoTable">
				<tr>
					<td class="leftTD">标题</td>
					<td class="rightTD"><input type="text" id="title" name="title" value="${n.title }"/></td>
				</tr>
				<tr>
					<td class="leftTD">内容</td>
					<td class="rightTD">
						<textarea rows="8" cols="15" name="content">${n.content }</textarea>
					</td>
				</tr>
				<tr>
					<td class="leftTD"></td>
